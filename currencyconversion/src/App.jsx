...
function App() {
  ...
  const convert = () => {
    setConvertedAmount(Number.parseFloat(amount * currencyInfo[to]).toFixed(2));
  };
  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="w-full max-w-md ax-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white-white/30">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert();
